  ...
  const features = [
    {
      ...
      description: [
        "MVP-ready frontend solutions delivered in 2 weeks.",
        "Custom, scalable web applications with stunning UIs.",
        "30 days of post-launch support and optimization.",
        "Smooth integration of APIs, payments, and authentication.",
        "Transparent development progress with weekly updates.",
        "Founder-led personalized service.",
        "Complete social media (X and Instagram) handling, starting from 2nd week.",
